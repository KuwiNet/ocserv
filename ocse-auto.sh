...
####################################################
#                                                  #
# This is a ocserv installation for CentOS.        #
# Version: 1.0.0 2022-01-16.                       # 
# Author: Darny Don                                #
# Website: https://www.sanmi.org                   #
#                                                  #
####################################################
...
# 检测是否是CentOS或者RHEL
if [[ $(grep "release." /etc/redhat-release 2>/dev/null | wc -l) -eq 0 ]]; then
    printf "\e[42m\e[31mError: Your OS is NOT CentOS or RHEL.\e[0m\n"
    printf "\e[42m\e[31mThis install script is ONLY for CentOS and RHEL.\e[0m\n"
    exit 1
fi
